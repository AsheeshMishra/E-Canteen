...
<body>
	...
	<section class="shop_items">
		<img class="shop_items_img" src="paneer.jpeg" width="200px" height="200px">
		<p class="item_description"><strong>Paneer curry</strong><br>Description</p>
		<span class="price">price : 30</span>
	<p><button id='bs21' onclick="addToCart(this.id)" class="price_button">+</button><button id='but1' class='price_button'>Add</button><button id="bs21" onclick="removeFromCart(this.id)" class="price_button">-</button></p>		
	</section>
	<section class="shop_items">
		<img class="shop_items_img" src="chicken_gravy.jpeg" width="200px" height="200px">
		<p class="item_description"><strong>Chicken Curry</strong><br>Description</p>
		<span class="price">price : 40</span>
		<p><button id='bs22' onclick="addToCart(this.id)" class="price_button">+</button><button id='but2' class='price_button'>Add</button><button id="bs22" onclick="removeFromCart(this.id)" class="price_button">-</button></p>		
	</section>
	<section class="shop_items">
		<img class="shop_items_img" src="momos.jpeg" width="200px" height="200px">
		<p class="item_description"><strong>Momos</strong><br>Description</p>
		<span class="price">price : 50</span>
		<p><button id='bs23' onclick="addToCart(this.id)" class="price_button">+</button><button id='but3' class='price_button'>Add</button><button id="bs23" onclick="removeFromCart(this.id)" class="price_button">-</button></p>		
	</section>
	<section class="shop_items">
		<img class="shop_items_img" src="puri.jpeg" width="200px" height="200px">
		<p class="item_description"><strong>Puri-Sabzi</strong><br>Description</p>
		<span class="price">price : 60</span>
		<p><button id='bs24' onclick="addToCart(this.id)" class="price_button">+</button><button id='but4' class='price_button'>Add</button><button id="bs24" onclick="removeFromCart(this.id)" class="price_button">-</button></p>
...
//All changes to javascript
		...
		function addToCart(id)
		{
			if(id=='bs21')
			{ 
				if(sessionStorage.getItem('list_of_food_selected_b_shop2_1')!=null)
				{
					num1=num1+1;
					sessionStorage.setItem('list_of_food_selected_b_shop2_1',id+','+num1+','+price1+','+'paneer.jpeg');
				}
				else
				{
					num1=1;
			...
			{
				if(sessionStorage.getItem('list_of_food_selected_b_shop2_2')!=null)
				{
					num2+=1;
					sessionStorage.setItem('list_of_food_selected_b_shop2_2',id+','+num2+','+price2+','+'chicken_gravy.jpeg');
				}
				else
				{
				num2=1;
			...
			{
				if(sessionStorage.getItem('list_of_food_selected_b_shop2_3')!=null)
				{
					num3+=1;
					sessionStorage.setItem('list_of_food_selected_b_shop2_3',id+','+num3+','+price2+','+'momos.jpeg');
				}
				else
				{
				num3=1;
				sessionStorage.setItem('list_of_food_selected_b_shop2_3',id+','+num3+','+price3+','+'momos.jpeg');
			}
			button3.innerHTML=num3;
			}
			else
			{
				if(sessionStorage.getItem('list_of_food_selected_b_shop2_4')!=null)
				{
					num4+=1;
					sessionStorage.setItem('list_of_food_selected_b_shop2_4',id+','+num4+','+price4+','+'puri.jpeg');
				}
				else
				{
				num4=1;
		...
		function removeFromCart(id)
		{
			...
			{ 
				...
				if(sessionStorage.getItem('list_of_food_selected_b_shop2_1')!=null)
				{
					...
					if(num1==0)
					{	//console.log('working');
						sessionStorage.removeItem('list_of_food_selected_b_shop2_1');
			...
			else if(id=='bs22'&& num2>0)
			{
				...
				if(sessionStorage.getItem('list_of_food_selected_b_shop2_2')!=null)
				{
					...
					if(num2==0)
					{	//console.log('working');
						sessionStorage.removeItem('list_of_food_selected_b_shop2_2');
			...
			else if(id=='bs23'&& num3>0)
			{
				...
				if(sessionStorage.getItem('list_of_food_selected_b_shop2_3')!=null && num3>0)
				{
					num3-=1;
					if(num3==0)
					{
						button3.innerHTML='Add';
						sessionStorage.removeItem('list_of_food_selected_b_shop2_3');
						return;
					}
					sessionStorage.setItem('list_of_food_selected_b_shop2_3',id+','+num3+','+price2+','+'momos.jpeg');
					button3.innerHTML=num3;
		...
		else
		{
			...
			if(sessionStorage.getItem('list_of_food_selected_b_shop2_4')!=null && num4>0)
			{
				num4-=1;
				if(num4==0)
				{	//console.log('working');
					sessionStorage.removeItem('list_of_food_selected_b_shop2_4');
...
<body>
		...
		<table>
			<tr>
				...
				<th class="shop_image">
						<h4>Food Point</h4>
					<a href="b_block_shop2.html"><img src="food1.jpg" alt="shop1"></a>
					<p class="shop_text">
					text about shop
					</p>
				</th>
...
//All changes to javascript
		...
		function addToCart(id)
		{
			...
			{ 
				...
				{
					num1=num1+1;
					sessionStorage.setItem('list_of_food_selected_b_shop2_1',id+','+num1+','+price1+','+'food1.jpg');
				}
				else
				{
					num1=1;
			...
			else if(id=='bs22')
			{
				...
				{
					num2+=1;
					sessionStorage.setItem('list_of_food_selected_b_shop2_2',id+','+num2+','+price2+','+'food1.jpg');
				}
				else
				{
				num2=1;
			...
			else if(id=='bs23')
			{
				...
				{
					num3+=1;
					sessionStorage.setItem('list_of_food_selected_b_shop2_3',id+','+num3+','+price2+','+'food1.jpg');
				}
				else
				{
				num3=1;
				sessionStorage.setItem('list_of_food_selected_b_shop2_3',id+','+num3+','+price3+','+'food1.jpg');
			}
			button1.innerHTML=num1;
			}
			else
			{
				...
				{
					num4+=1;
					sessionStorage.setItem('list_of_food_selected_b_shop2_4',id+','+num4+','+price4+','+'food1.jpg');
				}
				else
				{
				num4=1;
